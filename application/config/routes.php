...
$route['leads'] = 'admin/leads_login';
$route['leads/login'] = 'admin/leads_login';
...
$route['admin/enquiries/delete/(:num)'] = 'admin/delete_enquiry/$1';
$route['admin/enquiries/clear_empty'] = 'admin/clear_empty_enquiries';
