...
<!-- 1. HERO BANNER SECTION (MATCHING IMAGE 4) -->
<section class="ref-hero-section">
  <!-- Hero Background Slider Track -->
  <div class="ref-hero-slider">
    <div class="slider-track">
      <div class="slide active" style="background-image: url('<?php echo base_url('assets/images/slider-images/holidays/bali.png'); ?>');"></div>
      <div class="slide" style="background-image: url('<?php echo base_url('assets/images/slider-images/holidays/china.png'); ?>');"></div>
      <div class="slide" style="background-image: url('<?php echo base_url('assets/images/slider-images/holidays/japan.png'); ?>');"></div>
      <div class="slide" style="background-image: url('<?php echo base_url('assets/images/slider-images/holidays/scandinavia.png'); ?>');"></div>
      <div class="slide" style="background-image: url('<?php echo base_url('assets/images/slider-images/holidays/singapre & malaysias.png'); ?>');"></div>
      <div class="slide" style="background-image: url('<?php echo base_url('assets/images/slider-images/holidays/vietnam & cambodia.png'); ?>');"></div>
    </div>
  </div>
  ...
  <div class="container ref-hero-container">
    <div class="ref-hero-header-row">
      ...
      <div class="ref-hero-text-block">
        <h1 class="ref-dest-title">Bali</h1>
        <p class="ref-dest-subtitle">Island of Endless Wonders</p>

        <div class="ref-feature-pills">
          <div class="ref-feature-pill">
            <div class="ref-feature-pill-icon"><i class="fa-solid fa-umbrella-beach"></i></div>
            <span class="ref-feature-pill-text">Breathtaking Beaches</span>
          </div>
          <div class="ref-feature-pill">
            <div class="ref-feature-pill-icon"><i class="fa-solid fa-landmark-dome"></i></div>
            <span class="ref-feature-pill-text">Rich Culture</span>
          </div>
          <div class="ref-feature-pill">
            <div class="ref-feature-pill-icon"><i class="fa-solid fa-mountain-sun"></i></div>
            <span class="ref-feature-pill-text">Unforgettable Experiences</span>
          </div>
          <div class="ref-feature-pill">
            <div class="ref-feature-pill-icon"><i class="fa-regular fa-heart"></i></div>
            <span class="ref-feature-pill-text">Perfect for Every Traveller</span>
          </div>
        </div>
      </div>
...
<!-- 2. FLOATING HORIZONTAL ENQUIRY FORM & TRUST BADGES (MATCHING IMAGE 4) -->
<section class="ref-form-section">
  <div class="container">
    <div class="ref-form-card">
      <div class="ref-form-inner">
        <div class="holidays-split-layout">

          <!-- Left Info Panel -->
          <div class="holidays-left-panel">
            <div class="holidays-left-badge">
              <i class="fa-solid fa-tree-palm holidays-palm-icon" style="color: #E72D2D; font-size: 2.2rem;"></i>
              <div>
                <h3 style="color: #E72D2D; margin: 0; line-height: 1.1;">Plan Your</h3>
                <h3 style="color: #0B1938; margin: 0; line-height: 1.1;">Holiday</h3>
              </div>
            </div>
            <p class="holidays-left-desc">Tell us your travel plans and we'll get back with the best options!</p>
          </div>
            ...
            <div class="holidays-grid-2col">
              ...
              <div class="ref-form-group">
                <div class="ref-phone-group">
                  ...
                  <div class="ref-input-box" style="flex: 1;">
                    ...
                    <input type="tel" name="phone" class="ref-input" placeholder="Contact Number *" required>
                  </div>
                </div>
              </div>
              ...
              <div class="ref-form-group">
                <div class="ref-input-box">
                  ...
                  <input type="text" name="travel_date" class="ref-input" placeholder="Date of Travel *"
              ...
              <div style="display: flex; gap: 12px; align-items: center;">
                <div class="ref-input-box" style="flex: 1;">
                  ...
                  <select name="passengers" class="ref-select" required>
                    ...
                    <option value="3-5 People (Family)">3-5 People (Family)</option>
                    <option value="6+ People (Group)">6+ People (Group)</option>
                  </select>
                </div>
                <button type="submit" class="ref-btn-submit" style="flex-shrink: 0;">
    ...
    <div class="ref-trust-bar">
      ...
      <div class="ref-trust-item">
        <div class="ref-trust-icon"><i class="fa-solid fa-gears"></i></div>
        <div class="ref-trust-text">Customized<br>Itineraries</div>
      </div>
      <div class="ref-trust-item">
        <div class="ref-trust-icon"><i class="fa-solid fa-users-rays"></i></div>
        <div class="ref-trust-text">Trusted by<br>Thousands</div>
      </div>
    </div>
...
<!-- 3. POPULAR HOLIDAY DESTINATIONS SECTION (MATCHING IMAGE 4) -->
<section class="ref-popular-section">
  <div class="container">
    <div class="ref-section-header">
      <h2 class="ref-section-title">Popular Holiday Destinations</h2>
      <div class="ref-header-right">
        <a href="#" onclick="openEnquiryModal('View All Holiday Destinations')" class="ref-view-all-link">
    ...
    <div class="ref-cards-grid">
      ...
      <div class="ref-dest-card"
        ...
        onclick="openEnquiryModal('Bali Holiday Package')">
        <div class="ref-dest-overlay">
          <div class="ref-dest-info">
            <h4>Bali</h4>
            <p>4N / 5D | From ₹ 45,000</p>
          </div>
      ...
      <!-- Maldives -->
      <div class="ref-dest-card"
        style="background-image: url('<?php echo base_url('assets/images/voyogo maladives.png'); ?>');"
        onclick="openEnquiryModal('Maldives Holiday Package')">
        <div class="ref-dest-overlay">
          <div class="ref-dest-info">
            <h4>Maldives</h4>
            <p>4N / 5D | From ₹ 65,000</p>
          </div>
          <div class="ref-dest-arrow"><i class="fa-solid fa-arrow-right"></i></div>
        </div>
      </div>
      ...
      <!-- Singapore -->
      <div class="ref-dest-card"
        style="background-image: url('<?php echo base_url('assets/images/voyogo singapore.png'); ?>');"
        onclick="openEnquiryModal('Singapore Holiday Package')">
        <div class="ref-dest-overlay">
          <div class="ref-dest-info">
            <h4>Singapore</h4>
            <p>4N / 5D | From ₹ 55,000</p>
          </div>
          <div class="ref-dest-arrow"><i class="fa-solid fa-arrow-right"></i></div>
        </div>
      </div>
      ...
      <div class="ref-dest-card"
        ...
        onclick="openEnquiryModal('Thailand Holiday Package')">
        <div class="ref-dest-overlay">
          <div class="ref-dest-info">
            <h4>Thailand</h4>
            <p>4N / 5D | From ₹ 42,000</p>
          </div>
          <div class="ref-dest-arrow"><i class="fa-solid fa-arrow-right"></i></div>
        </div>
      </div>
    ...
    <div class="trending-grid-container">
      <div class="trending-grid" id="trendingGrid">
        ...
        <div class="trending-card" onclick="openEnquiryModal('Azerbaijan Trending Package')">
          <div class="trending-card-img"
            style="background-image: url('<?php echo base_url('assets/images/voyogo Azerbaijan.png'); ?>');">
        ...
        <div class="trending-card" onclick="openEnquiryModal('Hong Kong Trending Package')">
          <div class="trending-card-img"
            style="background-image: url('<?php echo base_url('assets/images/voyogo hong kong.png'); ?>');">
        ...
        <div class="trending-card" onclick="openEnquiryModal('Phu Quoc Trending Package')">
          <div class="trending-card-img"
            style="background-image: url('<?php echo base_url('assets/images/voyogo phu quoc.png'); ?>');">
        ...
        <div class="trending-card" onclick="openEnquiryModal('Almaty Trending Package')">
          <div class="trending-card-img"
            style="background-image: url('<?php echo base_url('assets/images/voyogo almaty.png'); ?>');">
    ...
    <div class="section-header-wrapper">
      <div class="header-title-tabs">
        ...
        <div class="intl-tabs">
          ...
          <span class="intl-tab">America</span>
        </div>
      </div>
